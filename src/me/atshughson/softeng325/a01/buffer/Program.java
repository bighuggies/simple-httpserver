...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        Buffer<Integer> buffer = new BufferImplWithJavaConcurrency<Integer>(
                BUFFER_SIZE);
        ...
        Thread bufferMonitorThread = new Thread(new BufferMonitor<Integer>(
                buffer));
        ...
        try {
            ...
            System.out
                    .println("Joined with buffer monitor thread - buffer is empty");
            ...
            // Synchronise with the death of each consumer thread and process
            // its
            // consumed data.
            for (int i = 0; i < consumerThreads.length; i++) {
                consumerThreads[i].join();
                System.out.println("Joined with "
                        + consumerThreads[i].getName());
